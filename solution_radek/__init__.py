...
def default_config():
    ...
    `lime_config.config['plugins']['solution_radek']`
...
try:
    ...
    logger.info('solution_radek doesn\'t implement any custom '
                'endpoints')

try:
    from .event_handlers import register_event_handlers  # noqa
except ImportError:
    logger.info('solution_radek doesn\'t implement any event '
                'handlers')

try:
    from .limeobject_classes import register_limeobject_classes  # noqa
except ImportError:
    logger.info('solution_radek doesn\'t implement any '
                'limeobject classes')
...
try:
    ...
    logger.info('solution_radek doesn\'t contain any '
                'translations')

try:
    from .config import register_config  # noqa
except ImportError:
    logger.info('solution_radek doesn\'t contain any config')
